...
La selección del microcontrolador se baso en las características las cuales los puntos mas importantes a considerar son: costo del dispositivo, velocidad de procesamiento y que posea comunicación por puerto serial.

Se estima que el costo del dispositivo sea accesible para los estudiantes que necesiten utilizar el programa puedan implementar el dispositivo real. Se necesita que la comunicación entre los dispositivos se lo mas rápido posible y esto se mide con la velocidad de procesamiento del dispositivo.

Como se detallo en la sección  \ref{sec:diint} la comunicación entre la interfaz de emulación de la planta de segundo orden y el controlador, la comunicación se realiza por puerto serial. Para seleccionar y discriminar el dispositivo que mejor se ajusta a los requerimientos mencionados se utilizo el gráfico 
