De acuerdo con la tabla \ref{tab:requisitos}, la plataforma tecnológica seleccionada para el diseño está basada en el lenguaje de programación Python. Para esto se contempló realizar una interfaz gráfica que contenga comunicación serial, cálculos matemáticos, modificación de texto y posibilidad de mostrar el gráfico de las señales, para lo cual se utilizaron varios paquetes integrados como lo es TKinter, Matplotlib y Numpy.
...
Una vez recibido un nuevo valor desde el puerto serial, se evalúa la longitud del mensaje, ya que pueden existir valores vacios. Si este es válido, se procederá a procesar la respuesta según la ecuación \ref{ec:salidaDiscretaCodigo}. En el caso contrario, el valor se ignora.
