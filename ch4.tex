...
\begin{description}
	\item[a.] Selección del puerto para la comunicación serial con el controlador.
...
\end{figure}
	...
	\item[b.] La configuración de los parámetros del sistema de segundo orden.
...
Luego se definen los arreglos vacíos de entrada, salida y tiempo, con los inputs respectivos y se obtienen los valores del sistema de segundo orden  y las variables de los pasos siguientes se definen con valor de cero.
	...
	\item[c.] Configuración de los parámetros del controlador.
	\item[d.] Graficar la respuesta controlada y sin controlar.
	
	Una vez terminado 
	\item[e.] Obtener los datos de tiempo de alza, tiempo de establecimiento y sobrepico del sistema controlado.
\end{description}
