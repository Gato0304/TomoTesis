...
\begin{description}
	...
	Se utilizo la librería pySerial \cite{serial} la cual es una extensión compatible con  Windows 32 bits, OSX, Linux, BSD, Jython y IronPython, dejando configurar el puerto a través de las propiedades de Python. 
	
	Se conecto el puerto serial a 921600 baudios y con un timeout de 10 seg. Se habilitó una entrada para poder insertar el puerto  por el cual se va a realizar la comunicación serial con el controlador real y un botón para conectarlo donde saldrá un mensaje de si la comunicación fue correcta o ocurrió un error en el proceso.
...
\end{figure}
	...
	\item[b.] \textbf{La configuración de los parámetros del sistema de segundo orden.}
...
Luego se definen los arreglos vacíos de entrada, salida y tiempo, con los inputs respectivos y se obtienen los valores del sistema de segundo orden  y las variables de los pasos siguientes se definen con valor de cero. En el diagrama \ref{fig:confip} se muestra la configuración de la planta
...
En los siguientes diagramas se muestra la manera de en que se ejecuta la comunicación:
