En este capítulo se explican los fundamentos necesarios para el modelado de la planta de segundo orden y el motor escogido para modelar un sistema de segundo orden. A demás, se realiza una comparación entre el circuito de segundo orden y sistema emulado.  
...
Donde los valores de $R_{1}, R_{2}, C_{1}, C_{2}$, $\omega_{n}$, y $\zeta$ son incógnitos, primero se obtendrán los valores de  $\omega_{n}$, y $\zeta$ a partir de \ref{ec:plantaarmaduracompleta} y \ref{ec:segundoorden} :
