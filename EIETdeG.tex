...
\noindent
\textbf{Palabras Claves:} Hardware in the loop, HIL, emulación, control, controlador, sistema de segundo orden. \\[1ex]

\noindent \textbf{Resumen.} 

El principal objetivo de este trabajo fue el diseño de una planta de segundo orden emulada con un controlador real. Partiendo de un software de emulación realizado python donde se modela y configura la planta de segundo orden.

En este caso el método Hardware in the loop considera el problema de realizar pruebas físicas que pueden considerarse costosas o peligrosas, la mezcla entre componentes virtuales y reales nos permite estudiar la interacción de los componentes.

Para el controlador real se utilizó un dispositivo ESP8266 el cual permite crear un código para un PID adaptable a las características deseadas.
...
\input{ch3.tex}%
%==================================================================
\chapter{Descripción del modelo de la planta de segundo orden.}\label{CAP:accio}
%\markboth{Tu Primer Capítulo}{Tu Primer Capítulo}%
\input{ch4.tex}%

%==================================================================
\chapter{Diseño de la interfaz de emulación de la planta de segundo orden.}\label{CAP:accino}
%\markboth{Tu Primer Capítulo}{Tu Primer Capítulo}%
\input{ch5.tex}%

%==================================================================
\chapter{Selección del dispositivo microcontrolador a utilizar}\label{CAP:met}
%\markboth{Tu Segundo Capítulo}{Tu Segundo Capítulo}%
\input{ch6.tex}%

%==================================================================
\chapter{Definición de los parametros a controlar}\label{CAP:mod}
%\markboth{Tu Segundo Capítulo}{Tu Segundo Capítulo}%
\input{ch7.tex}

%==================================================================
\chapter{Diseño del controlador digital a utilizar}\label{CAP:exp}
%\markboth{Tu Segundo Capítulo}{Tu Segundo Capítulo}%
\input{ch8.tex}
